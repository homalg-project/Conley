#############################################################################
##  
##  PackageInfo.g for the package `Conley'                Mohamed Barakat
...
##  one line.
Subtitle := "A &homalg; based Package for Conley Index Theory",
...
# 
ArchiveURL := "http://wwwb.math.rwth-aachen.de/~barakat/Conley",
...
#
README_URL := 
  "http://wwwb.math.rwth-aachen.de/~barakat/gap/Conley/README.Conley",
PackageInfoURL := 
  "http://wwwb.math.rwth-aachen.de/~barakat/gap/Conley/PackageInfo.g",
...
PackageDoc := rec(
  ...
  Archive := 
    "http://wwwb.math.rwth-aachen.de/~barakat/gap/Conley/Conley.tar.gz",
  ...
  LongTitle := "A &homalg; based Package for Conley Index Theory",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["GAPDoc", ">= 1.0"], ["homalg", ">= 2009.03.26"]],
...
#        " (", ~.Persons[3].WWWHome, ")\n",
  "Type:\n",
  "  ?Conley:                   ## for the contents of the manual\n",
  "  ?Conley:x                  ## for chapter/section/topic x\n",
  "----------------------------------------------------------------\n" ),
...
Keywords := ["Conley index theory", "connection matrices", "transition matrices"]
